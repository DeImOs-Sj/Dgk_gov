...
import pluginX402Plugin from "../dist/index.js";
import {
  createExpressApp,
...
describe("@dkg/plugin-x402 checks", function () {
  ...
  beforeEach(async () => {
    ...
    // Initialize plugin
    pluginX402Plugin(mockDkgContext, mockMcpServer, apiRouter);
    await connect();
    app.use("/", apiRouter);
  });
  ...
  describe("Plugin Configuration", () => {
    it("should create plugin without errors", () => {
      expect(pluginX402Plugin).to.be.a("function");
    });
  });
